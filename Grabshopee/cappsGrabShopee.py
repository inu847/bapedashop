...
def scrap(key):
    ...
    for page in range(0,10000,50):
        URL = 'http://127.0.0.1:8000/grabItems?url=https://shopee.co.id/api/v4/search/search_items?by=pop&limit='+ page +'&match_id='+ userId +'&newest=0&order=desc&page_type=shop&scenario=PAGE_OTHERS&version=2'
