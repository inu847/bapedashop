...
@endif
    ...
    <div class="panel">
        <div class="panel-heading ">
            <span class="panel-title ptn">Akun Seller</span>
        </div>
            ...
            <div class="table-responsive">
                <table class="table allcp-form theme-warning tc-checkbox-1 table-style-2 btn-gradient-grey fs13">
                    ...
                    <tr>
                        ...
                        <td class=""><span>{{$seller->nama_toko}}</td>
                        <td><span class="btn btn-warning br2 btn-xs fs10 fw700">{{$seller->status}}</span></td>
                        <td class="">
                        ...
                        <td>
                            <form action="{{ route('active.seller', [$seller->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
