            ...
            <div class="card d-flex flex-row mb-3">
                ...
                <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                    <div class="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                        <p class="list-item-heading mb-0 truncate w-15 w-sm-50">{{ Str::ucfirst($order->nama_product) }}</p>
                        <p class="mb-0 text-muted text-small w-15 w-sm-50">{{$pesanan->quantity}} Pcs</p>
                        ...
                        <div class="w-15 w-sm-50">
                            @if ( $pesanan->status == 'process' || $pesanan->status == 'pending')
